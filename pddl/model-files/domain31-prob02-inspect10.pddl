...
(define (problem inspection10)
    ...
    (:objects   ;interesting objects for inspection
                ...
                valve1 valve2 - valve 
                box1 - control-box
                vessel1 vessel2 vessel3 - regular-vessel
                wall1 wall2 wall3 wall4 - wall
                vessel4 - toggle-vessel
                switch1 - vessel-switch
                ;waypoints
    ...
    (:init  ;Specify coordinate values (imported from file in misc):
            ...
            (by-interesting w14x w14y box1)
            (by-interesting w5x w5y vessel1)
            (by-interesting w20x w20y vessel2)
            (by-interesting w11x w11y vessel3)
            (by-interesting w8x w8y wall1)
            (by-interesting w10x w10y wall2)
            (by-interesting w13x w13y wall3)
            (by-interesting w15x w15y wall4)
            (by-interesting w9x w9y vessel4)

            ;specify where switch is located
            (by-control w17x w17y switch1)
            (switch-connected switch1 vessel4)
